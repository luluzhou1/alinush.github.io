...
The question that remains to be answered is what is the _vector representation_ $\vec{a_8}$ of $C_8$, since that's what we'll need to efficiently evaluate $C_8\vec{x}$ and thus $T_4\vec{x}$.
