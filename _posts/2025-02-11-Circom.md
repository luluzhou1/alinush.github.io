...
As far as I can tell, `var` is a poor-name for a _"compile-time derivable linear combination of signals"_, because that's typically what you put in a `var`.

Either that, or you put constants or any other compile-time variable.
